import { uuid, integer, timestamp, primaryKey } from 'drizzle-orm/pg-core';
import { metrics } from './_schema.js';

// Calca metrics.metricas_equipo_partido. PK compuesta (equipo, partido).
export const metricasEquipoPartido = metrics.table(
  'metricas_equipo_partido',
  {
  ...
  (t) => [primaryKey({ columns: [t.equipoId, t.partidoId] })],
);
